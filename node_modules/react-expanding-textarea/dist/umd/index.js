(function (factory) {
    ...
    exports.getHeight = function (rows, el) {
    ...
    exports.resize = function (rows, el) {
        if (el) {
    ...
    var ExpandingTextarea = function (_a) {
        ...
        var ref = forwardedRef || react_1.createRef();
        ...
        return (react_1.default.createElement("textarea", tslib_1.__assign({}, props, { onInput: handleInput, ref: forwardedRef || ref, rows: rows })));
    };
